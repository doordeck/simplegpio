...
/*
 * (C) Copyright 2013 jcommon/process and others.
 *
...
public class LibEpoll {
    ...
    */
    ...
    public static native int epoll_create(int size) throws LastErrorException;

    //extern int epoll_create1 (int __flags) __THROW;
    public static native int epoll_create1(int flags) throws LastErrorException;

    //extern int epoll_ctl (int __epfd, int __op, int __fd, struct EpollEvent *__event) __THROW;
    public static native int epoll_ctl(int epfd, int op, int fd, EpollEvent.ByReference event) throws LastErrorException;
    public static native int epoll_ctl(int epfd, int op, int fd, Pointer event) throws LastErrorException;

    //extern int epoll_wait (int __epfd, struct EpollEvent *__events, int __maxevents, int __timeout);
    public static native int epoll_wait(int epfd, Pointer events, int maxevents, int timeout) throws LastErrorException;
