...
import com.doordeck.simplegpio.gpio.PinBlockedException;
import com.doordeck.simplegpio.gpio.PinFeature;
import com.doordeck.simplegpio.gpio.event.FeatureActivationEventArgs;
import com.doordeck.simplegpio.gpio.event.FeatureActivationListener;
...
public class Pin {
     ...
     *
     * @param <T>
     *       the type (classname) of the desired feature
     * @param feature
     *       the type (classname) of the desired feature
     */
     ...
     *
     * @param feature
     *       the instance of the feature to be added
    ...
    public Pin addFeature(PinFeature feature) {
        for (PinFeature feat : getFeatures()) {
            if (feat.getClass().equals(feature.getClass())) {
                throw new IllegalArgumentException("This pin already possesses the feature you're trying to add!");
            }
        }
     ...
     * a pin for usage with a desired feature (e.g. DigitalIO).
     *
     * @param <T>
     *       the concrete type of the pin feature.
     * @param feature
     ...
     *
     * @param blocker
     *       the pin feature that should block the pin.
     */
    public void block(PinFeature blocker) {
        if (getBlocker() != null && getBlocker() != blocker) {
     ...
     *
     * @param blocker
     *       the feature that currently blocks the pin. If
     ...
     *
     * @param feature
     *       the feature that is currently being activated
     */
